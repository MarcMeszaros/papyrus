...
public class LibrariesContentProvider extends ContentProvider {

	private static final String TAG = "LibrariesContentProvider";
	...
	static {
		...
		uriMatcher.addURI(AUTHORITY, "books", LIBRARIES);
		uriMatcher.addURI(AUTHORITY, "books/#", LIBRARY_ID);
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		// create an SQL builder object and set the table to libraries
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
		...
		switch (uriMatcher.match(uri)) {
		// update all libraries matching where clause
		case LIBRARIES:
			...
			// delete the library matching the id
		case LIBRARY_ID:
			// get the library id from the uri and build the query parts
			long id = ContentUris.parseId(uri);
			String whereClause = FIELD_ID + " = ?";
			String[] whereArgs = { Long.toString(id) };
